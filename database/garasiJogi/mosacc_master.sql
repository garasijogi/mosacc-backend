...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 29 Nov 2019 pada 03.46
...
--
-- Struktur dari tabel `aset-bangunan_tanah`
--
...
--
-- Struktur dari tabel `aset-kas_bank`
--
...
--
-- Struktur dari tabel `aset-kendaraan`
--
...
--
-- Struktur dari tabel `aset-peralatan`
--
...
--
-- Struktur dari tabel `aset-perlengkapan`
--
...
CREATE TABLE IF NOT EXISTS `profil_masjid` (
  ...
  `luas_tanah` varchar(32) DEFAULT NULL,
...
--
-- Struktur dari tabel `tr_database`
--
