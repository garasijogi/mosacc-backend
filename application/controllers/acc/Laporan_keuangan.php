...
class Laporan_keuangan extends CI_Controller
{
  ...
  {
    $this->load->view('acc/laporan_neraca_v.php');
  }

  function laporan_perubahan_dana()
  {
    $this->load->view('acc/laporan_perubahan_dana_v.php');
  }

  function laporan_aset_kelolaan()
  {
    $this->load->view('acc/laporan_aset_kelolaan_v.php');
  }
