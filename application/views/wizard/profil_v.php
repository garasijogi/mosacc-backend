                        ...
                        <div class="row">
                            ...
                            <div class="col s12">
                                <div class="row" id="namamasjid">
                                    <div class="input-field col s12 edit-profil">
                                        <input id="rename-nama-masjid" type="text" class="validate wizard-form-check"
                                            required>
                                        <label for="rename-nama-masjid">Nama
                                            Masjid</label>
                                    </div>
                                </div>
                            </div>
                            <div class="col s12">
                                <div class="row" id="alamat-masjid">
                                    <div class="input-field col s12 edit-profil"> <input id="rename-alamat-masjid"
                                            type="text" class="wizard-form-check validate"><label
                                            for="rename-alamat-masjid">Alamat
                                            Masjid</label>
                                    </div>
                                </div>
                            </div>
                            <div class="col s12">
                                <div class="row" id="tahun-berdiri">
                                    <div class="input-field col s12 edit-profil"> <input id="rename-tahun-berdiri"
                                            type="number" class="validate wizard-form-check"><label
                                            for="rename-tahun-berdiri">Tahun
                                            Berdiri</label>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col s12">
                                <div class="row" id="telepon-sekretariat">
                                    <div class="input-field col s12 edit-profil">
                                        <input id="rename-telepon-sekretariat" type="number"
                            ...
                            <div class="col s12">
                                <div class="row" id="rekening-masjid">
                                    <div class="input-field col s12 edit-profil"> <input id="rename-rekening-masjid"
                                            type="number" class="validate wizard-form-check"><label
                    ...
                    <div class="profil-contents-wrapper">
                        <div class="row">
                            ...
                            <div class="col s12">
                                <div class="row" id="luas-tanah">
                                    <div class="input-field col s12 edit-profil"> <input id="rename-luas-tanah"
                                ...
                                <div class="row" id="ad-art">
                                    <div class="file-field input-field">
                                        ...
                                        <div class="file-path-wrapper">
                                            <input class="file-path validate wizard-form-check" type="text"
                        ...
                        <div id="wizard-profil-masjid-simpan" class="modal">
                            ...
                            <div class="modal-footer">
                                ...
                                <a href="wizard-struktur-dkm.html"
