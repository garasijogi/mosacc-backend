    ...
    <div class="content">
        <div class="container">
            ...
            <div class="profil-wrapper">
                ...
                <div class="profil-nav">
                    <ul>
                        ...
                        <a href="<?php echo base_url('mgr/profil/dkm'); ?>" class="menu-trigger profil-nav-active" id="struktur-dkm">
                            <li>Struktur DKM</li>
                        </a>
                ...
                <div class="profil-content">
                    <form name="form_edit_struktur_dkm" id="form_edit_struktur_dkm" action="<?php echo base_url('mgr/profil/proses_edit_struktur_dkm'); ?>" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="file-field input-field">
                                    ...
                                    <div class="file-path-wrapper">
                                        <input class="file-path validate" type="text" placeholder="Tambahkan File" value="<?php echo $files['struktur_dkm'][0]['nama']; ?>">
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="row">
                ...
                <a href="<?php echo base_url('mgr/profil/dkm') ?>" class="btn red">Batal</a>
            </div>
                    </form>
