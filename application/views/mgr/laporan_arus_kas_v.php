...
<body>
    ...
    <div class="content">
        <div class="col s12 breadcrumb-wrapper valign-wrapper">
            ...
            <a href="<?php echo base_url('mgr/laporan_keuangan/laporan_arus_kas'); ?>" class="breadcrumb">Laporan Arus Kas</a>
        </div>
    </div>
    <!-- breadcrumb -->
    ...
    <div class="container">
        ...
        <div class="row" style="display:none">
            <h6 class="center" id="title-laporan"><b><?php echo $this->session->userdata('nama_masjid'); ?><br>Laporan Arus Kas <br>Per <?php echo month_generator($bulan) . " " . $this->session->userdata('tahun'); ?></b></h6>
