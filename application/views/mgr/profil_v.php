		...
		<div class="container">
			...
			<div class="profil-wrapper">
				...
				<div class="profil-content">
						...
						<div class="row">
							...
							<div class="col s12">
								...
								<div class="row">
									...
									<div class="col s7">
										<p><?php echo $files['ad_art'][0]['ukuran'] ?> KB</p>
									</div>
									<div class="col s4">
										<p>Ekstensi File</p>
									</div>
									...
									<div class="col s7">
										<p><?php echo $files['ad_art'][0]['ekstensi'] ?></p>
									</div>
									<div class="col s4">
										<p>Tanggal Diupload</p>
									</div>
									<div class="col s1">
										<p> : </p>
									</div>
									<div class="col s7">
										<p><?php echo $files['ad_art'][0]['tanggal'] ?></p>
									</div>
								</div>
							</div>
							<div class="col s12">
								...
								<div class="row">
									...
									<div class="col s7">
										<p><?php echo $files['badan_hukum'][0]['ukuran'] ?> KB</p>
									</div>
									<div class="col s4">
										<p>Ekstensi File</p>
									</div>
									...
									<div class="col s7">
										<p><?php echo $files['badan_hukum'][0]['ekstensi'] ?></p>
									</div>
									<div class="col s4">
										<p>Tanggal Diupload</p>
									</div>
									...
									<div class="col s7">
										<p><?php echo $files['badan_hukum'][0]['tanggal'] ?></p>
									</div>
								</div>
							</div>
						</div>
					...
					<a href="<?php echo base_url('mgr/profil/edit_profil_masjid'); ?>" class="waves-effect waves-light btn btn-edit-profil">Edit
						Profil</a>
