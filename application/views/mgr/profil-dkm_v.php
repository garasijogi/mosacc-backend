...
<body>
	...
	<div class="content">
		<div class="container">
				...
				<div class="row">
					...
					<div class="col s12">
						...
						<div class="row">
							...
							<div class="col s7">
								<p><?php echo $files['struktur_dkm'][0]['ukuran'] ?> KB</p>
							</div>
							<div class="col s4">
								<p>Ekstensi File</p>
							</div>
							...
							<div class="col s7">
								<p><?php echo $files['struktur_dkm'][0]['ekstensi'] ?></p>
							</div>
							<div class="col s4">
							...
							<div class="col s7">
								<p><?php echo $files['struktur_dkm'][0]['tanggal'] ?></p>
							</div>
						</div>
					</div>
				</div>
			...
			<br>
		<?php endforeach; ?>
		<a href="<?php echo base_url('mgr/profil/edit_struktur_dkm') ?>" class="waves-effect waves-light btn btn-edit-profil">Edit
			Struktur</a>
				</div>
