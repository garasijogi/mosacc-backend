    ...
    <div class="content">
        ...
        <div class="row">
            ...
            <div class="col s12 m3">
                <div class="card">
                    <a href="<?php echo base_url('acc/buku_besar_utama/jurnal_umum'); ?>">
            ...
            <div class="col s12 m3">
                <div class="card">
                    <a href="<?php echo base_url('acc/buku_besar_utama/buku_besar'); ?>">
                        <div class="card-image">
            ...
            <div class="col s12 m3">
                <div class="card">
                    <a href="<?php echo base_url('acc/buku_besar_utama/neraca_saldo'); ?>">
                        <div class="card-image">
