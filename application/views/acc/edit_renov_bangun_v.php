...
<body>
    ...
    <div class="content">
        <div class="col s12 breadcrumb-wrapper valign-wrapper">
            ...
            <a href="<?php echo base_url('acc/form_input_renov_bangun?kd_akun=' . $kd_akun); ?>" class="breadcrumb"><?php echo ucwords(str_replace("_", " ", $nama_sub)); ?></a>
        </div>
    </div>
    <!-- breadcrumb -->
    ...
    <div class="container">
        ...
        <!-- form input -->
        <div class="form">
            <form action="<?php echo base_url('acc/form_input_renov_bangun/proses_edit_r'); ?>" method="POST" class="col s12">
                <div class="row">
