                ...
                <div class="profil-content">
                    <div class="profil-contents-wrapper">
                        <div class="row">
                            ...
                            <div class="col s12">
                                <div class="row">
                                    <div class="input-field col s12 edit-profil"> <input name="ttl_ketua" id="rename-ttl-ketua" type="text" class="datepicker" value="<?php echo $k->ttl; ?>"><label for="rename-ttl-ketua">Tempat Tanggal Lahir</label>
                                    </div>
                                </div>
                            </div>
                            <div class="col s12">
                ...
                <div class="profil-contents-wrapper">
                    <div class="row">
                        ...
                        <?php foreach ($sekretaris->result() as $s) : ?>
                            ...
                            <div class="col s12">
                                <div class="row">
                                    <div class="input-field col s12 edit-profil"> <input name="ttl_sekretaris" id="rename-ttl-sekretaris" type="text" class="datepicker" value="<?php echo $s->ttl; ?>"><label for="rename-ttl-sekretaris">Tempat Tanggal Lahir</label>
                                    </div>
                                </div>
                            </div>
                            <div class="col s12">
            ...
            <div class="profil-contents-wrapper">
                <div class="row">
                    ...
                    <?php foreach ($bendahara->result() as $b) : ?>
                        ...
                        <div class="col s12">
                            <div class="row">
                                <div class="input-field col s12 edit-profil"> <input name="ttl_bendahara" id="rename-ttl-bendahara" type="text" class="datepicker" value="<?php echo $b->ttl; ?>"><label for="rename-ttl-bendahara">Tempat Tanggal Lahir</label>
                                </div>
                            </div>
                        </div>
                        <div class="col s12">
