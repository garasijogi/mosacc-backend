    ...
    <div class="content">
        ...
        <div class="row">
            ...
            <div class="col s12 m3">
                <div class="card">
                    <a href="<?php echo base_url('acc/laporan_keuangan/laporan_neraca'); ?>">
            ...
            <div class="col s12 m3">
                <div class="card">
                    <a href="<?php echo base_url('acc/laporan_keuangan/laporan_aktivitas?bulan=' . date('m') . '&&tampilan=bulanan'); ?>">
                        <div class="card-image">
            ...
            <div class="col s12 m3">
                <div class="card">
                    <a href="<?php echo base_url('acc/laporan_keuangan/laporan_arus_kas'); ?>">
                        <div class="card-image">
