			...
			<div class="">
				<div class="row">
					...
					<div class="col s12 m4">
						<div class="card">
							<div class="card-image">
								<img src="<?php echo base_url('assets/images/beban/beban-peribadatan-icon.png') ?>" width="300" height='350'>
					...
					<div class="col s12 m4">
						<div class="card">
							<div class="card-image">
								<img src="<?php echo base_url('assets/images/beban/beban-ramadhan-icon.png') ?>" width="300" height='350'>
					...
					<div class="col s12 m4">
						<div class="card">
							<div class="card-image">
								<img src="<?php echo base_url('assets/images/beban/beban-ziswaf-icon.png') ?>" width="300" height='350'>
				...
				<div class="row">
					<div class="col s12 m4 ">
						<div class="card">
							<div class="card-image">
								<img src="<?php echo base_url('assets/images/beban/beban-pendidikan-icon.png') ?>" width="300" height='350'>
			...
			<div class="">
				<div class="row">
					<div class="col s12 m4">
						<div class="card">
							<div class="card-image">
								<img src="<?php echo base_url('assets/images/beban/beban-operasional-icon.png') ?>" width="300" height='350'>
					...
					<div class="col s12 m4">
						<div class="card">
							<div class="card-image">
								<img src="<?php echo base_url('assets/images/beban/beban-lainnya-icon.png') ?>" width="300" height='350'>
