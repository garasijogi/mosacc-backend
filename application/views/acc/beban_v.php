						...
						<div class="col s12 m4">
							<div class="card">
								<div class="card-image">
									...
									<a class="btn-floating halfway-fab btn-large waves-effect waves-light red modal-trigger"
										href="#rutin1"><i class="material-icons">add</i></a>
								</div>
								<div class="card-content">
									<p>Digunakan untuk mencatat pengeluaran yang dikeluarkan untuk kegiatan peribadatan.
									</p>
						...
						<div class="col s12 m4">
							<div class="card">
								<div class="card-image">
									...
									<a class="btn-floating halfway-fab waves-effect btn-large waves-light red modal-trigger"
										href="#rutin2"><i class="material-icons">add</i></a>
								</div>
								<div class="card-content">
						...
						<div class="col s12 m4">
							<div class="card">
								<div class="card-image">
									...
									<a class="btn-floating halfway-fab waves-effect btn-large waves-light red modal-trigger"
										href="#rutin3"><i class="material-icons">add</i></a>
								</div>
								<div class="card-content">
						...
						<div class="col s12 m4 ">
							<div class="card">
								<div class="card-image">
									...
									<a class="btn-floating halfway-fab waves-effect btn-large waves-light red modal-trigger"
										href="#rutin4"><i class="material-icons">add</i></a>
								</div>
								<div class="card-content">
						...
						<div class="col s12 m4">
							<div class="card">
								<div class="card-image">
									...
									<a class="btn-floating halfway-fab btn-large waves-effect waves-light red modal-trigger"
										href="#tdk_rutin1"><i class="material-icons">add</i></a>
								</div>
								<div class="card-content">
						...
						<div class="col s12 m4">
							<div class="card">
								<div class="card-image">
									...
									<a class="btn-floating halfway-fab waves-effect btn-large waves-light red modal-trigger"
										href="#tdk_rutin2"><i class="material-icons">add</i></a>
								</div>
								<div class="card-content">
